														...
														<li class="nav-item" style="margin-bottom: 10px;">
															...
															<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
																...
																if (isset($_POST['descricao']) && empty($_POST['descricao']) == false ) {
																	...
																	$sql = "UPDATE produtos SET   preco = '$preco', quantidade = '$quantidade', fabricante = '$fabricante' , categoria = '$categoria', descricao = '$descricao' WHERE id = $id";
																	$pdo->query($sql);
																...
																<form method="POST">
																	...
																	<div class="row">
																		...
																		<dl class="col-4">	
																			...
																			<dt>Descrição:</dt>		<dd><input type="text" class="form-control" value="<?php echo $dado['descricao']; ?>" name="descricao"></dd>
																			<dt>Preço:</dt>		<dd><input type="text" class="form-control" value="<?php echo $dado['preco']; ?>" name="preco"></dd>	
																			<dt>Quantidade</dt>		<dd> <input type="text" name="quantidade" class="form-control" value="<?php echo $dado['quantidade']; ?>"></dd>	
																		...
																		<dl class="col-4">		
																			...
																			<dt>Fabricante:</dt>		<dd> 
																				<select name="fabricante" class="custom-select">
																					...
																					$sql = $pdo->prepare("SELECT * FROM fabricante ORDER BY nome ASC");

																					$sql->execute();


																					if ($sql->rowCount()>0) {
																						foreach($sql->fetchAll() as $fabricantes) {



																							echo "<option value=\"".$fabricantes['nome']."\">".$fabricantes['nome']."</option>\n";
																				...
																				<dt>Categoria:</dt>		<dd>
																					...
																					<select name="categoria" class="custom-select">
																						...
																						if ($sql->rowCount()>0) {
																							foreach($sql->fetchAll() as $categorias) {



																								echo "<option value=\"".$categorias['nome_cat']."\">".$categorias['nome_cat']."</option>\n";
																		...
																		<a href="visu.php?id=<?php echo $dado['id']; ?>" class="btn btn-danger">Voltar</a>
